          ...
          String10 *Password)
{
    ...
    verify = VerifyLogin(fileName, tempID, tempPass);
		   ...
		   int numImpressions)
{
	...
	printf("%s, patient # %s is a %d-year old %s. ", Patient.namePatient, Patient.numPatient, Patient.agePatient, pronoun);
	...
	fprintf(fp, "%s, patient # %s is a %d-year old %s. ", Patient.namePatient, Patient.numPatient, Patient.agePatient, pronoun);
			...
			int numImpressions)
{
	...
	printf("Si %s, ay isang pasyente na may ID# %s na %d-taong gulang na %s. ", Patient.namePatient, Patient.numPatient, Patient.agePatient, pronoun);
	...
	fprintf(fp, "%s, pasyente # %s ay isang %d taong gulang na %s. ", Patient.namePatient, Patient.numPatient, Patient.agePatient, pronoun);
